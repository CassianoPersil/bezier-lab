...
// =============================================================================
// TABS COMPONENT — Bézier UI (Radix UI powered)
// =============================================================================
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-9 items-center gap-1 rounded-lg p-1',
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      'text-sm font-medium text-ink-muted transition-all duration-150',
      'border border-transparent',
      'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent',
      'disabled:pointer-events-none disabled:opacity-50',
      'data-[state=active]:bg-surface-0 data-[state=active]:text-ink',
      'data-[state=active]:border-border',
      'data-[state=active]:shadow-sm',
      'hover:text-ink-subtle',
      className
    )}
    {...props}
  />
...
// ---------------------------------------------------------------------------
// Underline tabs variant (Linear-style)
// ---------------------------------------------------------------------------
...
export { Tabs, TabsList, TabsTrigger, TabsContent, TabsUnderlineList, TabsUnderlineTrigger }
